...
- **Convert** to a different type (castle / temple / city / tribal / nomad). Strips the old holding's buildings first to avoid the game freeze that vanilla `convert_to` causes. Hidden on any realm's capital (yours, vassals', and foreign realms').
